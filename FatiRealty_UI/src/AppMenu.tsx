    ...
    return (
        ...
        >
            <div className="menu-logo">
                <button className="logo p-link" style={{ color: '#242121' }} onClick={() => navigate('/')}>
                    {/* <span className="border-circle w-4rem h-4rem bg-white flex justify-content-center align-items-center">
                        <i className="pi pi-building text-4xl"></i>
                    </span> */}
                    <img src={`assets/layout/images/logo.png`} alt="logo" onClick={() => navigate('/')} />

                    {/* <img src={`assets/layout/images/logo-${props.colorScheme === 'light' ? 'dark' : 'light'}.png`} alt="logo" onClick={() => navigate('/')} /> */}
                </button>
                <button className="app-name p-link pl-3">
                    <h4 className="text-white m-0" onClick={() => navigate('/')}>
                        FATI Realty
                    </h4>
